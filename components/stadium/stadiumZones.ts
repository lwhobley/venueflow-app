/**
 * Generic stadium zone map for the home-page 3D spatial view.
 * Positions are in scene units relative to field center.
 * Specs mirror a large multi-purpose retractable-roof stadium
 * (field convertibility, suite counts, club levels, concourse capacities).
...
export const STADIUM_ZONES: StadiumZone[] = [
  {
    ...
    notes: 'Floor converts between football, soccer, concert, and general-session configurations.',
    color: '#2F6B3A',
  },
  {
    id: 'club-east',
