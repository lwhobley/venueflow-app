...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "Invite_phone_idx" ON "Invite"("phone");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "Subscription_externalCustomerId_idx" ON "Subscription"("externalCustomerId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "TimeEntry_venueId_clockInAt_idx" ON "TimeEntry"("venueId", "clockInAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "TimeEntry_isOpen_idx" ON "TimeEntry"("isOpen");
...
-- RenameIndex
ALTER INDEX IF EXISTS "PosLaborPunch_venueId_provider_externalEmployeeId_businessDa_ke" RENAME TO "PosLaborPunch_venueId_provider_externalEmployeeId_businessD_key";
