...
export default function WranglerScreen() {
  ...
  const handleAction = (action: WranglerAction) => {
    if (action.type === 'NAVIGATE' || action.type === 'ACKNOWLEDGE') { router.push(action.route); return; }
