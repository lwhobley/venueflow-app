...
(function () {
  ...
  function FeaturePill({
    ...
    return /*#__PURE__*/React.createElement("div", {
      style: {
        ...
        background: '#fff',
        borderRadius: 18,
        boxShadow: '0 12px 26px rgba(20,20,40,0.12)',
  ...
  function AppWindow() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      style: {
        ...
        background: '#FBFCFD',
        borderRadius: 24,
        boxShadow: '0 44px 96px rgba(20,20,40,0.22)',
        overflow: 'hidden',
    ...
    }, "Venue Wrangler")), /*#__PURE__*/React.createElement("div", {
      style: {
        marginLeft: 'auto',
  ...
  function Storefront() {
    ...
    }, "BELLA'S BISTRO"), /*#__PURE__*/React.createElement("div", {
      style: {
        height: 46,
        borderRadius: '14px 14px 4px 4px',
        background: 'repeating-linear-gradient(90deg, #FF6B5C 0 34px, #FFF3E2 34px 68px)',
  ...
  function Lasso() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      style: {
        ...
        width: 600,
        height: 600,
        transform: `translate(-50%,-50%) scale(${scale}) rotate(${s * 420}deg)`,
        opacity: op * 0.9,
        borderRadius: '50%',
        border: `14px dashed ${VW.teal}`,
        boxShadow: `0 0 50px ${VW.teal}66`
      }
    });
  }
  function Confetti() {
    ...
    for (let k = 0; k < 18; k++) {
      ...
      dots.push(/*#__PURE__*/React.createElement("div", {
        ...
        style: {
          position: 'absolute',
          left: 960 + Math.cos(a) * dist,
          top: 460 + Math.sin(a) * dist,
          width: 16,
          height: 16,
          borderRadius: k % 2 ? '50%' : 3,
          background: colors[k % 5],
          opacity: 1 - s,
          transform: `translate(-50%,-50%) rotate(${s * 360}deg)`
        }
      }));
    }
  ...
  function Backdrop() {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      style: {
        position: 'absolute',
        inset: 0,
        background: 'radial-gradient(circle at 50% 40%, #FFE6CE, #FBD4B6)'
      }
    }), /*#__PURE__*/React.createElement("div", {
      style: {
        position: 'absolute',
        inset: 0,
        background: 'radial-gradient(circle at 50% 45%, #EDF9F3, #D6EFE7)',
        opacity: calm
      }
    }), /*#__PURE__*/React.createElement("div", {
      style: {
  ...
  function Tagline() {
    ...
    }, "Every venue, wrangled."), /*#__PURE__*/React.createElement("div", {
      style: {
        fontFamily: FONT_BODY,
        fontSize: 23,
        color: '#6B7A77',
    ...
    }, "Scheduling, reservations, floor, CRM, inventory & more \u2014 one shared workspace."));
  }
  function Camera({
    children
  }) {
    const t = useTime();
    const zoom = interpolate([0, T.chaosStart, T.wrangle, T.wrangle + 0.3, T.snap, T.settle], [1.0, 1.0, 1.12, 1.18, 1.0, 1.0], Easing.easeInOutCubic)(t);
    ...
    return /*#__PURE__*/React.createElement("div", {
      style: {
        ...
        transform: `scale(${zoom}) translate(${sx}px,${sy}px)`,
        willChange: 'transform'
      }
    }, children);
  }
  function VWScene() {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Backdrop, null), /*#__PURE__*/React.createElement(Camera, null, /*#__PURE__*/React.createElement(Storefront, null), CHAOS.map((it, i) => /*#__PURE__*/React.createElement(ChaosItem, {
      key: i,
      item: it,
      i: i
    })), /*#__PURE__*/React.createElement(Lasso, null), /*#__PURE__*/React.createElement(AppWindow, null), FEATURES.map((f, i) => /*#__PURE__*/React.createElement(FeaturePill, {
      key: i,
      i: i
    })), /*#__PURE__*/React.createElement(Confetti, null)), /*#__PURE__*/React.createElement(Tagline, null));
  }
  ...
  function VenueWranglerOpener({
    onDone
  }) {
    return /*#__PURE__*/React.createElement(WebStage, {
      duration: SCENE_PLAY_TO,
      onDone: onDone
    }, /*#__PURE__*/React.createElement(VWScene, null));
  }
